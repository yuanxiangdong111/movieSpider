...
func Test_rarbg_Crawler(t *testing.T) {
	...
	//log.Errorf("%#v", proxyStr)
	//log.Errorf("%#v", proxyURL)
	//transport := &http.Transport{
	//	Proxy: proxyURL,
	//}
	//log.Errorf("%#v", transport)
	//httpClient := &http.Client{Transport: transport, Timeout: time.Minute * 5}
	//log.Errorf("%#v", httpClient)
	//resp, _ := httpClient.Get("http://cip.cc")
	...
	//feedRarbg.Run()
	//select {}
	//crawler, err := feedRarbg.Crawler()
	//if err != nil {
	//	t.Error(err)
	//}

	//for _, v := range crawler {
	//	fmt.Println(v)
	//}

	//doc := etree.NewDocument()
	//err := doc.ReadFromString(d)
	//if err != nil {
	//	t.Error(err)
	//}
	//elements := doc.SelectElement("rss")
	//element := elements.SelectElement("channel")
	//for _, element := range element.SelectElements("item") {
	//	// 种子名
	//	fmt.Println(element.SelectElement("title").Text())
	//	// 磁力连接
	//	fmt.Println(element.SelectElement("link").Text())
	//
	//}
}
